...
$Source: /cvsroot/projectfactory/development/net/sourceforge/projectfactory/server/actors/Absence.java,v $
$Revision: 1.9 $
...
/** Absence composed by a date and duration.
  * Generated by David Lambert
  * On Monday, January 29, 2007 3:36:29 PM CET
  * Using Factory 0.4.8.4
  */
public class Absence extends Duration {
    public java.util.Date absence;

    /** Writes the object as an XML output. */
    public void xmlOut(WriterXML xml, TransactionXML transaction, boolean tags) {
        if (tags) xmlStart(xml, "absence");
        super.xmlOut(xml, transaction, false);
        if (transaction.isDetail() || transaction.isSave()) {
            xmlAttribute(xml, "absence", absence);
        }
        if (tags) xmlEnd(xml);
    }
