...
$Source: /cvsroot/projectfactory/development/net/sourceforge/projectfactory/client/components/CheckBox.java,v $
$Revision: 1.5 $
...
/**
 * Default check box in the application.
 * @author David Lambert
 */
public class CheckBox extends JCheckBox implements ComponentEnabler {
    ...
    public CheckBox(String title) {
        super("<html>" + LocalMessage.get(title) + "</html>");
        setTitle(LocalMessage.get(title));
