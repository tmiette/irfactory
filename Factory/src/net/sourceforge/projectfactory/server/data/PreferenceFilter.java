...
$Source: /cvsroot/projectfactory/development/net/sourceforge/projectfactory/server/data/PreferenceFilter.java,v $
$Revision: 1.1 $
$Date: 2007/02/01 22:18:06 $
$Author: ddlamb_2000 $
...
/** 
  ...
  * On Thursday, February 1, 2007 10:22:42 PM CET
  * Using Factory 0.4.8.5
  */
public class PreferenceFilter extends BaseEntity {
    ...
    public void xmlOut(WriterXML xml, TransactionXML transaction, boolean tags) {
        ...
        if (transaction.isDetail() || transaction.isSave()) {
            xmlAttribute(xml, "category", category);
            xmlAttribute(xml, "filter", filter);
            xmlAttribute(xml, "search", search);
        }
        if (tags) xmlEnd(xml);
    }
